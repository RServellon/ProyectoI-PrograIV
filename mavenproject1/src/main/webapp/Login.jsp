<%-- 
    Document   : Login
    Created on : Apr 13, 2022, 7:04:07 PM
    Author     : @
--%>
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center container-login">
           <form method="POST" name="pagina_logeo" action="login">
               
            <div class="mb-md-5 mt-md-4 pb-5">
              <h2 class="fw-bold mb-2 text-uppercase">Login</h2>
              <p class="mb-5" color="gray">Por favor digite su usuario y contrasena!</p>
...
<!--                Aqui se debe de colocar la pagina GENERAL para registrar (quitar registroMedico y registroCliente)-->
              <p class="mb-0">Si no tienes una cuenta registrate <a href="VistaCliente/RegistroCliente.jsp" class="text-primary fw-bold">aqui</a>
              </p>
            </div>
