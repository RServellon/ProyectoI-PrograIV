...
<%
    //querry 
    String nombre = (String) request.getAttribute("first-name");
    String apellido = (String) request.getAttribute("last-name");
    String id = (String) request.getAttribute("id");
    String errorCode = (String) request.getAttribute("error-code");
%>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" name="first-name" class="form-control" value="<%=nombre%>" />
                                                <label class="form-label" for="form3Example1">Nombre</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" name="last-name" class="form-control" value="<%=apellido%>" />
