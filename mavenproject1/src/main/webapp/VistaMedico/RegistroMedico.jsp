        ...
        <body>
            ...
            <section class="vh-100 background-radial-gradient overflow-hidden">
                ...
                <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5 align-items-center">
                    <div class="  mb-lg-0" id="head1" style="z-index: 10;">
                    ...
                    <div class="row gx-lg align-items-center mb-5">

                        <div class="col-md mb-5 mb-lg-0 position-relative">


                            <div class="card bg-glass">
                                <div class="card-body px-5 py-4 px-md-5">
