<%-- Document : RegistroMedico Created on : 13 abr. 2022, 0:12:21 Author : @ --%>
                ...
                <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
                    <div class="row gx-lg-5 align-items-center mb-5">
                        <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                            <h1 class="my-5 display-5 fw-bold ls-tight " color="gray">
                                Registro Cliente <br />
                                <h3 color="gray">Por Favor ingrese sus datos</h3>
                            </h1>
                            <p class="mb-4 opacity-70" color="gray">
                                Nota: Los datos enviados en este formulario deberán ser revisados en un plazo de 4 días
                                habiles
                            </p>
                        </div>
