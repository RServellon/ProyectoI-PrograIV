...
<%
    ...
    Medico med2 = new Medico("Odontologia", "Heredia", 5000, null, "Clinica", "estado", "foto de perfil", "resena", "id", "Sanji Vismoke", "pass2", "medico");
...
<!--Aqui se realiza for con la informacion de los medicos que existen segun la busqueda realizada-->
        ...
        <div class="row row-padding row-margin bg-secondary ">
